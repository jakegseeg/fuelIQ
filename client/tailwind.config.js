  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'line-card': 'rgb(var(--ios-separator) / <alpha-value>)',
        ...
        accent: {
          50: 'rgb(var(--sage-wash) / <alpha-value>)', 100: 'rgb(var(--sage-wash) / <alpha-value>)',
          200: 'rgb(var(--sage-soft) / <alpha-value>)', 300: 'rgb(var(--sage-ink) / <alpha-value>)',
          400: 'rgb(var(--sage) / <alpha-value>)', 500: 'rgb(var(--sage-ink) / <alpha-value>)',
          600: 'rgb(var(--sage-strong) / <alpha-value>)', 700: 'rgb(var(--sage-strong) / <alpha-value>)',
        },
      ...
      boxShadow: { card: 'none', glow: '0 0 0 3px rgb(var(--sage) / 0.24)' },
